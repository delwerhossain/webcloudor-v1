  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-slate-200/50 shadow-lg hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-500 h-full group-hover:border-blue-200 group-hover:-translate-y-2 group-hover:bg-white/90"
      >
        {/* Enhanced Icon - Mobile Optimized */}
        <motion.div
          className="relative inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl mb-5 sm:mb-6 group-hover:from-blue-100 group-hover:to-blue-200 transition-all duration-300 shadow-sm group-hover:shadow-md"
          whileHover={{ scale: 1.1, rotate: 5 }}
        >
          <service.icon className="w-7 h-7 sm:w-8 sm:h-8 text-blue-600 group-hover:text-blue-700 transition-colors duration-300" />
          {/* Glow effect */}
        ...
        <div className="space-y-3 sm:space-y-4">
          <h3 className="text-xl sm:text-2xl font-bold text-gray-900 group-hover:text-blue-700 transition-colors duration-300 leading-tight">
            {service.title}
          </h3>

          <p className="text-slate-600 leading-relaxed text-sm sm:text-base font-medium mb-3">
            {service.description}
          </p>
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-green-50 border border-green-200 rounded-full">
            <div className="w-1.5 h-1.5 bg-green-500 rounded-full flex-shrink-0"></div>
            <span className="text-green-700 font-semibold text-xs sm:text-sm">{service.result}</span>
          </div>
  ...
  return (
    <SectionContainer background="gray" padding="large">
      ...
      >
        ...
        >
          <div className="inline-flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 bg-gradient-to-r from-blue-50 to-blue-100 rounded-full mb-5 sm:mb-6">
            <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse flex-shrink-0"></div>
            <span className="text-blue-700 font-semibold text-xs sm:text-sm uppercase tracking-wider">Our Services</span>
          </div>

          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-5 sm:mb-6 leading-tight px-4">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto font-medium leading-relaxed px-4">
          ...
          <div className="flex justify-center items-center gap-3 sm:gap-4 mt-6 sm:mt-8">
            <div className="w-12 sm:w-16 h-0.5 bg-gradient-to-r from-transparent to-blue-300"></div>
            <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 bg-blue-500 rounded-full animate-pulse"></div>
            <div className="w-12 sm:w-16 h-0.5 bg-gradient-to-l from-transparent to-blue-300"></div>
          </div>
        </motion.div>
        ...
        {/* Bottom CTA hint - Mobile Enhanced */}
        <motion.div
        ...
        >
          <div className="space-y-4">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold text-base sm:text-lg rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl active:scale-[0.98] min-h-[52px] touch-manipulation"
            >
