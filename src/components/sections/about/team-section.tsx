  ...
  return (
    <SectionContainer background="white" padding="large">
      <div id="team-section" ref={ref} className="space-y-16">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#0A0A0B] px-4">
            The Team Behind the Results
          </h2>
          <p className="text-lg sm:text-xl text-[#64748B] max-w-2xl mx-auto px-4">
        ...
        <div className="space-y-16 sm:space-y-20 lg:space-y-24">
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              {/* Content */}
              <div className={`space-y-6 sm:space-y-8 px-4 sm:px-0 ${index % 2 === 1 ? 'lg:col-start-1' : ''}`}>
                <div>
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#0A0A0B] mb-2">
                    {member.name}
                  </h3>
                  <p className="text-base sm:text-lg text-[#00A8E8] font-semibold mb-4 sm:mb-6">
                    {member.role}
                  </p>
                ...
                {/* Expertise */}
                <div>
                  <h4 className="font-semibold text-[#0A0A0B] mb-3 sm:mb-4 text-sm sm:text-base">Expertise Areas:</h4>
                  <div className="flex flex-wrap gap-2">
                    {member.expertise.map((skill, skillIndex) => (
                      <motion.span
                        ...
                        className="px-2 sm:px-3 py-1 bg-[#00A8E8]/10 text-[#00A8E8] rounded-full text-xs sm:text-sm font-medium"
                      >
                        {skill}
                      </motion.span>
                    ))}
                ...
                <div>
                  <h4 className="font-semibold text-[#0A0A0B] mb-3 sm:mb-4 text-sm sm:text-base">Background Highlights:</h4>
                  <ul className="space-y-2">
                    {member.background.map((highlight, bgIndex) => (
                      <motion.li
                        ...
                        className="flex items-start space-x-3 text-[#64748B] text-sm sm:text-base"
                      >
                ...
                <motion.div
                  ...
                  className="p-4 sm:p-6 bg-gradient-to-r from-[#F8FAFC] to-white rounded-lg sm:rounded-xl border-l-4 border-[#00A8E8]"
                >
                  <blockquote className="text-[#0A0A0B] italic font-medium text-sm sm:text-base leading-relaxed">
                    "{member.quote}"
                  </blockquote>
                </motion.div>
                ...
                >
                  {member.links.linkedin && (
                    <Link
                      ...
                      className="flex items-center space-x-2 px-3 sm:px-4 py-2 sm:py-2 bg-[#0077B5] text-white rounded-lg hover:bg-[#0077B5]/90 transition-colors text-sm sm:text-base min-h-[44px] min-w-[44px] justify-center sm:justify-start"
                    >
                  ...
                  {member.links.github && (
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center space-x-2 px-3 sm:px-4 py-2 sm:py-2 bg-[#333] text-white rounded-lg hover:bg-[#333]/90 transition-colors text-sm sm:text-base min-h-[44px] min-w-[44px] justify-center sm:justify-start"
                    >
                      <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {member.links.email && (
                    <Link
                      ...
                      className="flex items-center space-x-2 px-3 sm:px-4 py-2 sm:py-2 bg-[#00A8E8] text-white rounded-lg hover:bg-[#00A8E8]/90 transition-colors text-sm sm:text-base min-h-[44px] min-w-[44px] justify-center sm:justify-start"
                    >
